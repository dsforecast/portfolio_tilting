function export_table_rmse2(filename,data,tests,row_names,col_names)
...
fprintf(fid,'\\caption{Relative root mean squared errors between expected target price return forecast errors and average return forecast errors for 22 Dow Jones constituents (sample: 1999 - 2015) }\r\n');
fprintf(fid,'\\label{tab:rmsfe2}\r\n');
