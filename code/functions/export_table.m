function export_table(filename,data,row_names,col_names,tabtitle,tabcaption,tabreference)
...
fprintf(fid,'\\caption{Descriptive statistics on the returens, target prices and recommendations for 22 Dow Jones constituents (sample: 1999 - 2015) }\r\n');
